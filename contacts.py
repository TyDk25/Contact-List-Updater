...
class Contacts:
    ...
    def create_label_frame(self):
        labelframe = LabelFrame(self.root, text='Create New Contact',bg="black",font="helvetica 10")
        ...
        Button(labelframe, text='Add Contact', command=self.on_add_contact_button_clicked,bg="black",fg="black").grid(row=4, column=2, sticky=E, padx=5, pady=5)
    ...
    def create_bottom_buttons(self):
        Button(text='Delete Selected', command=self.on_delete_selected_button_clicked,bg="black",fg="black").grid(row=8, column=0, sticky=W,pady=10,padx=20)
        Button(text='Modify Selected', command=self.on_modify_selected_button_clicked,bg="purple",fg="black").grid(row=8, column=1, sticky=W)
